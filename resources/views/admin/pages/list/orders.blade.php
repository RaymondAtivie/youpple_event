...
@section('main')
    ...
    <div class="page-head">
        ...
        <span class="sub-title">View all Service Orders of Youpple</span>
    </div>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        All Service Orders ({{count($orders)}})
                    </header>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @endforeach
                                        <br /><hr />
                                        <form method="POST" action="{{url("admin/list/orders/".$order['id']."/counter")}}">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="hidden" name="made_by" value="Youpple" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-sm-4">
