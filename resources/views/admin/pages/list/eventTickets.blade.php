...
@section('main')
    ...
    <div class="page-head">
        ...
        <span class="sub-title">View tickets for <b>{{$event->title}}</b> event on Youpple</span>
    </div>
    <style>
    .bold{
        font-weight: bold;
