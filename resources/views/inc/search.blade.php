...
<ul class="nav nav-tabs nav-justified" role="tablist">
    <li role="presentation" class="active"><a href="#events{{$num}}" aria-controls="home" role="tab" data-toggle="tab">Search Events</a></li>
    <li role="presentation"><a href="#providers{{$num}}" aria-controls="profile" role="tab" data-toggle="tab">Search Service Providers</a></li>
</ul>

<!-- Tab panes -->

<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="events{{$num}}" style="padding: 20px;">
    ...
    <div role="tabpanel" class="tab-pane" id="providers{{$num}}" style="padding: 20px;">
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label>Name</label>
